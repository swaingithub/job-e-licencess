                ...
                <div class="tw-mb-5">
                    ...
                    <div class="tw-flex tw-flex-wrap tw-gap-2 tw-items-center tw-mb-1.5">
                        @if ($job->featured && $featured)
                            <span class="tw-text-[#06C] tw-text-[12px] tw-leading-[12px] tw-font-semibold tw-bg-[#E6F0FA] tw-px-2 tw-py-1 tw-rounded-[3px]">{{ __('featured') }}</span>
                        @endif
                        <span class="tw-text-[#0BA02C] tw-text-[12px] tw-leading-[12px] tw-font-semibold tw-bg-[#E7F6EA] tw-px-2 tw-py-1 tw-rounded-[3px]">{{ $job->job_type ? $job->job_type->name : '' }}</span>
                    </div>
                    <div>
...
@if ($job->job_provider && $job->job_provider == 'careerjet')
    ...
    <a href="{{ $job->url ?? '#' }}" target="_blank" class="card tw-card jobcardStyle1">
        <div class="tw-p-6">
            <div class="tw-mb-5">
                <div class="tw-mb-1.5">
                    <span class="tw-text-[#18191C] tw-text-lg tw-font-medium">
