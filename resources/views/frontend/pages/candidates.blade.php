                    ...
                    <div class="row">
                        @foreach ($candidates as $candidate)
                            <div
                                ...
                                <a onclick="showCandidateProfileModal('{{ $candidate->user->username }}')" href="javascript:void(0);" class="card jobcardStyle1 body-24">
                                    <div class="card-body">
                                        <div class="rt-single-icon-box icb-clmn-lg">
                                            ...
                                            <div class="iconbox-content">
                                                ...
                                                <div class="bottom-link mt-1">
                                                    @if (auth('user')->check())
                                                        <sapn class="body-font-4 text-primary-500">{{ __('view_resume') }}
                                                            <span>
        ...
        function showCandidateProfileModal(username) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#candidate_location').html(data.candidate.exact_location ? data.candidate.exact_location: data.candidate.full_address)
