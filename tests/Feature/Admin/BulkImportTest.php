...
it('can bulk import job category', function () {
    ...
    expect(JobCategoryTranslation::count())->toBe(6); // Check the count of imported translations
...
it('can bulk import industry types', function () {
    ...
    expect(IndustryTypeTranslation::count())->toBe(6); // Check the count of imported translations
...
it('can bulk import job role', function () {
    ...
    expect(JobRoleTranslation::count())->toBe(7); // Check the count of imported translations
...
it('can bulk import organization type', function () {
    ...
    expect(OrganizationTypeTranslation::count())->toBe(6); // Check the count of imported translations
...
it('can bulk import profession type', function () {
    ...
    // Assertions to check if the categories and translations were created correctly
    expect(Profession::count())->toBe(4); // Check the count of imported categories
    expect(ProfessionTranslation::count())->toBe(12); // Check the count of imported translations
...
it('can bulk import skill type', function () {
    ...
    expect(SkillTranslation::count())->toBe(6); // Check the count of imported translations
...
it('can bulk import tags type', function () {
    ...
    expect(TagTranslation::count())->toBe(6); // Check the count of imported translations
